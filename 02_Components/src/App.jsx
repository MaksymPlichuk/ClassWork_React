...
1921, 25 жовтня розпочався «Листопадовий Рейд» – Другий зимовий похід армії УНР проти більшовиків." textURL="https://uinp.gov.ua/istorychnyy-kalendar/zhovten/25/1921-pochatok-drugogo-zymovogo-pohodu" />
      ...
      <div className='shapesBox'>
        <Shape w="100px" h="100px" color="yellow" type="circle" />
        <Shape w="250px" h="200px" color="blue" type="" />
        <Shape w="250px" h="250px" color="purple" type="" />
        <Shape w="150px" h="150px" color="green" type="circle" />
      </div>
    </>
  )
}
